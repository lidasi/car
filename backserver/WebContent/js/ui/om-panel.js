...
(function($) {
	...
	$.omWidget("om.omPanel" , {
		...
		_renderHeader: function(){
			...
			//mrle
			// $("<div class='myIcon'></div>").appendTo($header);
			$("<div class='myIcon' style='float:left;display:inline;'></div>").html('&nbsp').appendTo($header);
			$("<div class='om-panel-title'style='left:3px;float:left;display:inline;'></div>").html('&nbsp&nbsp' + options.title).appendTo($header);
