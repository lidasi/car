...
public class ZXingUtil {    
	static Logger logger = Logger.getLogger(ZXingUtil.class);
    private ZXingUtil(){}    
     ...
     */    
    private static void overlapImage(String imagePath, String logoPath, int dpi) throws IOException {    
        ...
        new TiffOutput(image,imagePath,dpi);//生成分辨率为300dpi的二维码图片
//        ImageIO.write(image, imagePath.substring(imagePath.lastIndexOf(".") + 1), new File(imagePath));    
     ...
     */    
    public static boolean encodeQRCodeImage(String content, String charset, String imagePath, int width, int height, String logoPath,String dpi) {    
        ...
        try {    
            ...
            logger.error("编码待生成二维码图片的文本时发生异常");
            e.printStackTrace();    
            return false;    
        }    
...
//        MatrixToImageConfig config = new MatrixToImageConfig(0xFF000001, 0xFFFFFFFF);    
        ...
        try {   
        	int dpivalue = 300;
        	if (null != dpi && !"".equals(dpi)){
        		dpivalue = NumberUtils.toInt(dpi);
        	}
            MatrixToImageWriter.writeToFile(bitMatrix, imagePath.substring(imagePath.lastIndexOf(".") + 1), new File(imagePath),imagePath,dpivalue);  
        } catch (IOException e) {
        	logger.error("生成二维码图片[" + imagePath + "]时遇到异常");
        ...
        if(null == logoPath){    
            ...
            try {    
                ...
                overlapImage(imagePath, logoPath, dpivalue);    
                return true;    
            } catch (IOException e) {
            	logger.error("为二维码图片[" + imagePath + "]添加logo头像[" + logoPath + "]时遇到异常");
    ...
    public static String decodeQRCodeImage(String imagePath, String charset) {    
        ...
        try {    
        	...
        	logger.error("二维码图片[" + imagePath + "]解析失败");
...
//    	ZXingUtil.encodeQRCodeImage("flfAW88ejjmYrTgkcH4", null, "d:/flfAW88ejjmYrTgkcH4.png", 300, 300, null,null);
    	ZXingUtil.encodeQRCodeImage("A1000006A209AC", null, "d:/hbqrcode/A1000006A209AC.png", 300, 300, null,null);
